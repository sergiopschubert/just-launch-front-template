...
import { ISettingsTabsProps } from "@/app/[locale]/(users)/domain/props/ISettingsTabsProps";

export function ProfileContent({ profile:{name, email},  intl }: ISettingsTabsProps) {
  return (
