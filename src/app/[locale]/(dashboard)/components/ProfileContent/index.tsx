'use client';
import { Input } from '@/@JustLaunch/components/Input';
...
export function ProfileContent({
  profile: { name, email },
  intl,
  imgURL = 'https://api.dicebear.com/7.x/bottts-neutral/svg?seed=Aneka&backgroundColor=bfdbfe&eyes=happy',
}: ISettingsTabsProps) {
  return (
      ...
      <div className='ml-5 lg:max-w-md'>
        <div className='flex flex-col'>
          ...
          <form className='w-full space-y-4 px-8'>
            <img src={imgURL} className='h-14 w-14 rounded-full' alt={''}></img>
            <Input.Root>
