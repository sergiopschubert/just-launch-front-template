import { ResetPasswordSchema, schema } from '@/app/[locale]/(auth)/domain/schemas/resetPassword';
...
import { IResetPasswordProps } from '../domain/props/IResetPasswordFormProps';

export const useResetPassword = ({ intl }: IResetPasswordProps) => {
const {
  register,
  handleSubmit,
  formState: { errors },
