...
>((props, ref) => {
  return (
    <textarea
      ...
      className={twMerge(
        'flex min-h-[80px] w-full resize-y items-center gap-2 rounded-lg border border-primary/300 px-3 py-2 text-gray-900 placeholder-gray-500 shadow-sm outline-none',
