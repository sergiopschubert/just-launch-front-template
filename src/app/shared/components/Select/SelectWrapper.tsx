    ...
    >
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          ...
          position='popper'
          sideOffset={7}
          className='z-10 z-50 w-[--radix-select-trigger-width] overflow-hidden rounded-lg border border-primary/300 bg-white text-sm text-gray/800 focus-within:border-primary/300 focus-within:ring 
